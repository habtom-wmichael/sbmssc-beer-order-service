package com.sbmssc.beerorder.app.sbmsscbeerorderservice.web.controller;

import com.sbmssc.beerorder.app.sbmsscbeerorderservice.services.BeerOrderService;
...
public class BeerOrderController {
    ...
    public void updateOrder(@PathVariable("customerId") UUID customerId,
                                    @PathVariable("orderId") UUID orderId){

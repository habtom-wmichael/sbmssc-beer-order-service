...
import com.sbmssc.beerorder.app.sbmsscbeerorderservice.bootstrap.BeerOrderSeed;
...
public class TastingRoomService {
    ...
    public TastingRoomService(CustomerRepository customerRepository, BeerOrderService beerOrderService,
        ...
        beerUpcs.add(BeerOrderSeed.BEER_1_UPC);
        beerUpcs.add(BeerOrderSeed.BEER_2_UPC);
        beerUpcs.add(BeerOrderSeed.BEER_3_UPC);
    }
    ...
    public void placeTastingRoomOrder(){
        ...
        List<Customer> customerList = customerRepository.findAllByCustomerNameLike(BeerOrderSeed.TASTING_ROOM);
